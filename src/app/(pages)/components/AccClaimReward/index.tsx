        ...
        <div className="fixed inset-0  bg-black/50  flex justify-center items-center z-50 ">
          <div className="relative bg-white w-80 rounded-lg p-6 text-center">
            ...
            <button
              ...
              className="bg-black text-white text-sm py-2 px-4 rounded mb-2 hover:bg-gray-800 text-gray-800 "
            >
              Confirm
            </button>
            ...
            <button className="bg-red-500 text-white text-sm py-2 px-4 rounded hover:bg-red-600 text-gray-800 ">
              Level Up
            </button>
          </div>
        </div>
